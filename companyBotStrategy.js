...
// In this case, the bot's correct answer time for a given task would be the average of the answer 
// times from the trainers who answered correctly. Given all of the training information for a specific task, 
