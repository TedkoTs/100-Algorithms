...
// "commercial", "organization", "network" or "information" for .com, .org, .net or .info respectively. 
...
const domainType = domains => {
    ...
    domains.forEach(element => {
        ...
        } else if (x[x.length - 1] === 'com') {
            types.push('commercial')
        } else if (x[x.length - 1] === 'net') {
            types.push('network')
        } else if (x[x.length - 1] === 'info') {
